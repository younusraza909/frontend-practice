...
export default function Home() {
  ...
  return (
    <main className='max-w-7xl mx-auto max-xl:max-w-5xl max-lg:max-w-3xl max-md:px-10'>
      ...
      <section className='product  max-lg:flex-col flex items-center max-xl:gap-6 gap-20 my-20 mx-10'>
        ...
        <div className='product-info flex-1'>
          ...
          <div className='cart flex gap-16 my-5'>
            ...
            <div className=' cursor-pointer card-cta-btn bg-[color:var(--primary-color)] text-white px-10 rounded-lg py-3 max-xl:py-0 flex items-center  justify-between gap-11'>
              <div className=''>
              ...
              <p className='whitespace-nowrap text-sm font-bold max-xl:text-xs'>
                Add to card
              </p>
            </div>
          </div>
